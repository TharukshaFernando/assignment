            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="nic" class="col-md-4 col-form-label text-md-right">NIC No.</label>
                        ...
                        <div class="form-group row">
                            <label for="tel" class="col-md-4 col-form-label text-md-right">Telephone/Mobile</label>
                      ...
                      <input type="checkbox" class="@error('t&c') is-invalid @enderror" value="1" id="t&c" name="t&c" required /> Terms and Conditions
